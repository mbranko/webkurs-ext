...
public class Product implements Serializable {
  ...
  public String toString() {
    return "Product [id=" + id + ", name=" + name + ", vendor=" + vendor + ", description=" + description + ", price="
        + price + ", category=" + category.getName() + ", supplier=" + supplier.getName() + "]";
  }

  private static final long serialVersionUID = -6954992372608161054L;
}
