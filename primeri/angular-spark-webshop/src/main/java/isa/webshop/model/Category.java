...
public class Category implements Serializable {
  ...
  public String toString() {
    return "Category [id=" + id + ", name=" + name + ", description=" + description + ", parent=" + (parent != null ? parent.getName(): "<null>") + "]";
  }

  private static final long serialVersionUID = -1964946891277711018L;
}
