...
<jsp:useBean id="user" scope="session" class="isa.pr19.entity.User"/>
<jsp:useBean id="order" scope="session" class="isa.pr19.entity.PurchaseOrder"/>
<html>
  <head>
  ...
  <body>
    ...
    <form action="pay" method="post">
      <table style="spacing:0;padding:2px;border:0">
	      <tbody>
	         <tr>
	           <td>Ukupan iznos:</td>
	           <td>${order.total}</td>
